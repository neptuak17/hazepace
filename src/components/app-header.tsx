 ...
 * screens change underneath it. The place row opens the places sheet, which
 * is mounted once in PlacesSheetProvider so Today's location card can open
 * the same one.
 */
...
import { DataStrings, HeaderStrings } from '@/constants/strings';
